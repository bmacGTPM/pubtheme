...
theme_pub <- function (type = 'scatter',
  ...
  th = theme(line = element_line(colour    = pubtextgray,
             ...
             axis.title          = NULL,
             axis.title.x        = element_text(margin = margin(t = 30*px, unit = 'in'), 
                                                vjust  = 1),
             
             axis.title.x.top    = element_text(margin = margin(b = 30*px, unit = 'in'), 
                                                vjust  = 0),
             
             axis.title.x.bottom = NULL,
             axis.title.y        = element_text(margin = margin(r = 30*px, unit = 'in'), 
                                                vjust  = 1, 
                                                angle  = 90),
             axis.title.y.left   = NULL,
             axis.title.y.right  = element_text(margin = margin(l = 30*px, unit = 'in'), 
                                                vjust  = 0, 
                                                angle  = -90),
             
             axis.text          = NULL,
             axis.text.x        = element_text(margin = margin(t = 20*px, unit = 'in'), 
                                               vjust  = 1),
             axis.text.x.top    = element_text(margin = margin(b = 20*px, unit = 'in'), 
                                               vjust  = 0),
             axis.text.x.bottom = NULL,
             axis.text.y        = element_text(margin = margin(r = 20*px, unit = 'in'), 
                                               hjust  = 1),
             axis.text.y.left   = NULL,
             axis.text.y.right  = element_text(margin = margin(l = 20*px, unit = 'in'), 
                                               hjust  = 0),
             ...
             plot.title      = element_text(size   = 50/36*base_size, 
                                            hjust  = 0, 
                                            vjust  = 1, 
                                            margin = margin(0, 0, b = 70*px, 0, 
                                                            unit = 'in'), 
                                            color  = pubdarkgray, 
                                            face   = 'bold'),
             plot.title.position = 'plot',
             plot.subtitle = element_text(size   = 42/36*base_size, 
                                          hjust  = 0, 
                                          vjust  = 1, 
  ...
  if(type == 'scatter'){
    th = th + theme(panel.grid.major.x = element_line(colour = publightgray))
    }
  
  if(type == 'pairs'){
    th = th + theme(panel.grid.major.x = element_line(colour = publightgray),
                    panel.border       = element_rect(color  = pubtextgray, 
                                                      fill   = NA),
