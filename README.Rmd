...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), 
       plot   = g,
       width  = 6,    ## do not change
       height = 7,   ## can change from 20 if desired. We use 12 here to make the tiles square
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), ## must have a subfolder called 'img'
       plot   = g,
       width  = 6,    ## do not change
       height = 4.5,   ## can change from 20 if desired. We use 15 here b/c there are only 3 bars
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), 
       plot   = g,
       width  = 6,    ## do not change
       height = 3.6,   ## can change from 20 if desired. We use 12 here to make the tiles square
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
```
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), 
       plot   = g,
       width  = 6,    ## do not change
       height = 6,    ## can change from 6 if desired. We use 12 here to make the tiles square
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), ## must have a subfolder called 'img'
       plot   = g,
       width  = 6,    ## do not change
       height = 6,    ## can change from 6 if desired. We use 15 here because there are only 5 barbells
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
```
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), ## must have a subfolder called 'img'
       plot   = g,
       width  = 6,    ## do not change
       height = 3.6,   ## can change from 20 if desired. We use 12 here because there are only 5 lollipops
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
```
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), ## must have a subfolder called 'img'
       plot   = g,
       width  = 6,    ## do not change
       height = 4.5,   ## can change from 20 if desired. We choose 15 here b/c the extra space isn't needed
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), ## must have a subfolder called 'img'
       plot   = g,
       width  = 6,    ## do not change
       height = 4.5,   ## can change from 20 if desired. We use 15 here because there are only 5 barbells
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
```
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), 
       plot   = g,
       width  = 6,    ## do not change
       height = 3,   ## can change from 20 if desired. We use 10 here because there are only 4 coefficients.
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), 
       plot   = g,
       width  = 6,    ## do not change
       height = 3.6,   ## can change from 20 if desired. We use 10 here because there are only 4 coefficients.
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
```
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), ## must have a subfolder called 'img'
       plot   = g,
       width  = 6,    ## do not change
       height = 3.9,   ## can change from 20 if desired. Here we choose 13 so each subplot is square
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
...
ggsave(filename = paste0("img/", gsub("%", " Perc", title), ".jpg"), ## must have a subfolder called 'img'
       plot   = g,
       width  = 6,    ## do not change
       height = 6,    ## can change from 6 if desired. We use 12 here because there are only 5 lollipops
       units  = 'in', ## do not change
       dpi    = 300)   ## do not change
