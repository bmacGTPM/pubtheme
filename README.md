...
See [here](https://bmacgtpm.github.io/pubtheme/) to view the interactive
version of the plot.
...
``` r
htmltools::includeHTML('https://bmacgtpm.github.io/pubtheme/img/Title%20in%20Upper%20Lower.html')
```
