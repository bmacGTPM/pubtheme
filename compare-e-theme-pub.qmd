...
subtitle: "ggplot on the left, echarts4r on the right. base_size = 10."
format:
  html:
...
Compare the ggplot `theme_pub` / `pub()` look to `e_theme_pub()` at `base_size = 10`. Code is hidden; expand a chunk if you want the source.
